...
def masercov_fft(vals, wpm=0., fpm=0., wfm=0., ffm=0., rwfm=0., fwfm=0., step=1., scale=1.,
            ext_factor=10, return_dict=False):
...
def cov_fft(vals1, vals2, wpm=0., fpm=0., wfm=0., ffm=0., rwfm=0., fwfm=0., step=1., scale=1.,
            ext_factor=10, return_dict=False):
	...
	cv, noise_cv = masercov_fft(vals1+vals2, wpm=wpm, fpm=fpm, wfm=wfm, ffm=ffm, rwfm=rwfm, fwfm=fwfm, step=step, scale=scale, ext_factor=ext_factor, return_dict=True)	
...
if __name__ == "__main__":
	...
	cov, noise_cov = masercov_fft([vals1, vals2, np.array([[3, 4]])], **noise_dict, step=100, scale='day', return_dict=True, ext_factor=10)
